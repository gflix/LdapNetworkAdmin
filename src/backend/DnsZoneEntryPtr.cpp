...
DnsZoneEntryPtr::DnsZoneEntryPtr(const QString& description, const QString& fullyQualifiedHostname, const QString& ipAddressPart):
    GenericDnsZoneEntry(DnsZoneEntryType::PTR, description),
